...
```sh
  cd my-folder
  git clone https://github.com/FilbertKimasa/ruby-capstone.git
```
...
Feel free to check the [issues page](https://github.com/FilbertKimasa/ruby-capstone/issues).
